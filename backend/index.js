...
app.post('/api/complaints', verifyToken, async (req, res) => {
  try {
    console.log('=== COMPLAINT SUBMISSION (Backend) ===');
    ...
    console.log('Complaint saved successfully! ID:', newComplaint._id);
...
app.get('/api/complaints/all', verifyToken, async (req, res) => {
  try {
    ...
    // Debug: Log complaints with user info
    console.log('ADMIN FETCH ALL COMPLAINTS:');
